    ...
    switch (resultType)
    {
        ...
        case FBKAnalyticalRealTimeSteps:
        {
          //  [self.delegate getRealTimeStepsData:(NSDictionary *)resultData andDevice:self];
            ...
            NSNumber *nbtLevel = [[NSUserDefaults standardUserDefaults] objectForKey:@"battery_level"];
            int btLevel = nbtLevel.intValue;

            
            NSString *macID = [[NSUserDefaults standardUserDefaults] objectForKey:@"mac_address"];
//            int btLevel = nbtLevel.intValue;

            [self.delegate getRealTimeStepsData:(NSDictionary *)resultData andDevice:self macId:macID batterlyLevel:btLevel];
            break;
        }
