...
{
    NSLog(@"encryptionString start **************** %@",cmdString);
    int length = (int)cmdString.length/2;
    ...
    //    Byte encryption[16] = {0x97,0xa3,0x85,0x97, 0x98,0xa4,0x86,0x98, 0x99,0xa5,0x87,0x99, 0x9a,0xa6,0x88,0x9a};
    Byte encryption[1] = {0x08};
    if (!haveKey) {
        encryption[0] = 0x00;
    }
